...
import VariantCustomFieldsForm, {
	VariantCustomFieldsFormType,
} from "../variant-customFields-form";
...
export type EditFlowVariantFormType = {
	...
	customFields: VariantCustomFieldsFormType;
};
...
const EditFlowVariantForm = ({ form, isEdit }: Props) => {
	...
	return (
		<Accordion type="multiple" defaultValue={["general"]}>
			...
			{/* custom Fields */}
			<Accordion.Item title="Custom Fields" value="customFields">
				<VariantCustomFieldsForm form={nestedForm(form, "customFields")} />
			</Accordion.Item>
