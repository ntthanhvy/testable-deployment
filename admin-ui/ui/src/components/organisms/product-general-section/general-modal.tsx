...
import PersionalizeMessageForm, {
	PersonalizeMessageFormType,
} from "../../forms/product/personalized_message-form";
import Button from "../../fundamentals/button";
import Modal from "../../molecules/modal";

type Props = {
	product: Product & { personalized_message: boolean };
	open: boolean;
	onClose: () => void;
};
...
type GeneralFormWrapper = {
	...
	personalized_message: PersonalizeMessageFormType;
};
		...
		onUpdate(
			{
				...
				personalized_message: data.personalized_message.value,
			},
			onReset
		);
	});
				...
				<form onSubmit={onSubmit}>
					<Modal.Content>
						...
						<DiscountableForm
							...
							isGiftCard={product.is_giftcard}
						/>
						<PersionalizeMessageForm
							form={nestedForm(form, "personalized_message")}
						/>
...
const getDefaultValues = (
	...
	return {
		...
		personalized_message: { value: product.personalized_message },
	};
};
